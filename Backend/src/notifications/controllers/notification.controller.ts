...
export class NotificationController {
  ...
  @ApiParam({ name: 'userId', description: 'User ID' })
  @ApiResponse({ status: 200, description: 'Unread count retrieved', type: Number })
  async getUserUnreadCount(@Param('userId') userId: string): Promise<{ count: number }> {
  ...
  @ApiParam({ name: 'id', description: 'Notification ID' })
  @ApiResponse({ status: 200, description: 'Notification archived successfully', type: Notification })
  @ApiResponse({ status: 404, description: 'Notification not found' })
  ...
  async bulkArchiveNotifications(@Body() body: { ids: string[] }): Promise<void> {
  ...
  @ApiParam({ name: 'userId', description: 'User ID' })
  @ApiResponse({ status: 200, description: 'Preferences retrieved successfully', type: NotificationPreference })
  async getNotificationPreferences(@Param('userId') userId: string): Promise<NotificationPreference> {
  ...
  async updateNotificationPreferences(
    ...
    return this.notificationService.updateNotificationPreferences(userId, updateDto);
  }
  ...
  @ApiParam({ name: 'userId', description: 'User ID' })
  @ApiResponse({ status: 200, description: 'Notification type toggled', type: NotificationPreference })
  async toggleNotificationType(
    @Param('userId') userId: string,
    @Body() body: { type: NotificationType; enabled: boolean },
  ): Promise<NotificationPreference> {
    return this.notificationService.toggleNotificationType(userId, body.type, body.enabled);
  }
